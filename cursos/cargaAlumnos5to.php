...
$alumnos = mysql_query("SELECT nom_alumno, id_alumno FROM alumnos WHERE curso_alumno= $cursos[0]", $link);
...
while ($alumnosArray = mysql_fetch_array($alumnos)) {
    ...
    echo "
            <tr><td><input type='checkbox' class='checkboxAlumnos checkboxAlumnosQuinto' id='$idAlumno'></td><td><a onclick='$funcion' id='$idAlumno'>$nombreAlumno</a></td><td>$horasTotales</td></tr>
        ";
}